...
//        gravityParticle.setDamping(0.5);
        ...
        this.particleRegistry.add(
            gravityParticle,
//            new Ape.ParticleSpring(staticParticle, 100, this.restLength)
//            new Ape.ParticleSpring(staticParticle, 1000, this.restLength)
            new Ape.ParticleSpring(staticParticle, 5000, this.restLength)
        );
