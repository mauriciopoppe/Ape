(function () {
     ...
     * <hr>
     *
     * Clase cuyas instancias representan un cuerpo rígido, una idealizacion de una
     * estructura solida (lo que significa que no puede ser deformado bajo
     * cualquier fuerza aplicada)
     *
     * Esta clase contiene muchas caracteristicas del cuerpo rigido como:
     *
     * - Posicion
     * - Orientacion
     ...
     * - Tensor de inercia
     *
     * El cuerpo rigido tiene un metodo llamado Ape.RigidBody.integrate que integra
     * las caracteristicas del cuerpo rigido transformando sus propiedades con el
     * siguiente algoritmo:
     *
     * - Antes de que el metodo de integracion funcione, el cuerpo rigido
     * acumula fuerzas y torque para ser acumulado despues
     * - Cuando el metodo #integrate es llamado la fuerza y el torqie son
     * transformados en un cambio lineal y angular
     * - El cambio en la aceleracion lineal y angular es transformado a
     * un cambio en la velocidad lineal y angular del cuerpo rigido
     * - Estos cambios causan que la posicion y la orientacion del cuerpo
     * tambien cambie
     * - Los acumuladores (acumuladores de fuerza y torque) son limpiados
     * debido a que la fuerza solo se aplica durante un frame
     *
     * @class Ape.RigidBody
     */
    RigidBody = function () {
