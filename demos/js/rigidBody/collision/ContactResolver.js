/**
 * Class that resolves the contacts created by an instance of the class
 * Ape.CollisionDetector, this class resolves contact following this algorithm:
 *
 * - prepare the contacts for processing
 * - resolve the interpenetration problems among the contacts
 * - resolve the velocity problems among the contacts
 *
 * <hr>
 *
 * Clase que resuelve los contactos resueltos por una instancia de la clase
 * Ape.CollisionDetector, esta clase resuelve contactos siguiendo el siguiente
 * algoritmo:
 *
 * - Preparar los contactos para ser procesados
 * - Resolver los problemas de interpenetracion entre los contactos
 * - Resolver los problemas de velocidad entre los contactos
 *
