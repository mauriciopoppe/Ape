 ...
 * <hr>
 *
 * Clase utilitaria para guardar instacias de las subclases de la clase
 * Ape.force.ForceGenerator, debe existir una sola instancia de esta clase en toda
 * la aplicacion, la instancia esta a cargo de llamar al metodo `update()` de todas
 * las instancias registradas haciendo que cada una aplique una fuerza al
 * objeto registrado.
 *
