 ...
 * <hr>
 *
 * Asumamos que tenemos un plano paralelo al plano XZ que representa
 * un liquido con alguna densidad. Cuando un objeto cae a este liquido
 * se provoca que el liquido ejerza una fuerza al objeto que lo empuja
 * hacia arriba. Cuando el objeto esta completamente sumergido en el liquido
 * no importa cual es la magnitud de su profundidad, el liquido empujara
 * al objeto hacia arriba con la misma fuerza.
 *
 * El modelo simplificado de la flotabilidad:
 *
 * Si v es el volumen del objeto
 * Si p es la densidad del liquido
 *
 *      // if objectY > liquidHeight
 *      //      no hacer nada
 *      // else if objectY + height < liquidHeight
 *      //      empujar con v * p
 *      // else
 *      //      empujar con v * p * porcentaje de sumersion
 *
