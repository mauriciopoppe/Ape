 ...
 * of two objects and a pointer to a contact array to fill, if it
 * detects a contact it fills the corresponding contacts in the array and
 * returns the number of contacts it wrote into the array
 *
 * <hr>
 *
 * Una clase englobante que contiene las rutinas de deteccion de colisiones finas.
 *
 * Cada una de las funciones tiene el mismo formato: toma los detalles de
 * los objetos y un puntero al array de contactos que se tiene que llenar,
 * si se detect un contacto se llenan los contactos correspondientes en el array
 * y se retorna el número de contactos que escribio en el array
 *
