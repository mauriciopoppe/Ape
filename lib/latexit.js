...
var LatexIT = {
	...
	pre : function(txt) {
		...
		//	txt = " <object type=\"image/svg+xml\" width=\"20\" data=\"http://latex.codecogs.com/"+this.mode+".latex?"+ txt +"\" /> ";
		  ...
		  if(this.mode=='svg' && this.isFirefox) {
		    txt = " <object type=\"image/svg+xml\" data=\"http://latex.codecogs.com/"+this.mode+".latex?"+ txt +"\" class=\"latex\" style=\"margin:0; padding:0; border:0\"></object> ";
          } else {
	...
	latex : function(txt) {
		var html, htmlinline;
		if(this.mode=='svg' && this.isFirefox) {
		  html=" <object type=\"image/svg+xml\" data=\"http://latex.codecogs.com/"+this.mode+".latex?$2\" alt=\"$2\" title=\"$2\" class=\"latex\"></object> ";
		  htmlinline=" <object type=\"image/svg+xml\" data=\"http://latex.codecogs.com/"+this.mode+".latex?\\inline $2\" alt=\"$2\" title=\"$2\" class=\"latex\"></object> ";
		}
		else {
